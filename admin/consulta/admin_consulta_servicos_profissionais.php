    ...
    <div class="container-fluid"><br>
        ...
        <div class="container">
            ...
            <div class="div-consultas">
                <span>Serviços e profissionais</span>
            </div><br>

            <a href="/salao-de-beleza/admin/cadastrar/admin_cadastrar_profservic.php" class="btn btn-dark">Associar Serviço/Profissional</a><br><br>
            
            <div>
                <form action="admin_consulta_servicos_profissionais.php" method="get" class="d-flex justify-content-center mb-4">
            ...
            <table class="table table-hover table-striped">
                ...
                <tbody>
                    <?php
                        ...
                        WHERE 
                            s.nome_Servico LIKE '%$nome_Servico%'";
                        ...
                        foreach($resultado as $linha) {
                            echo "
                                <tr>
                                    ...
                                    <td>
                                        <a href='/salao-de-beleza/admin/excluir/admin_exluir_profservic.php?id_Servico=" . $linha['id_Servico'] . "' class='btn btn-danger'>🗑️</a>
                                    </td>
                                <tr>
                            ";
                        }
