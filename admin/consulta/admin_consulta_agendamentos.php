...
<head>
    ...
    <title>Ic's Hair - Agendamentos</title>
...
<body>
    <div class="container-fluid"><br>
        ...
        <div class="container">
            ...
            <div>
                <form action="admin_consulta_agendamentos.php" method="get" class="d-flex justify-content-center mb-4">
                    <input type="text" class="form-control form-pesquisa w-75" name="nome_Cliente" placeholder="Digite o NOME para pesquisa"> <!-- w-75: 75% do tamanho do elemento pai -->
                ...
                <tbody>
                    <?php
                        ...
                        FROM 
                            agendamento a
                        JOIN 
                            agenda_cliente ac ON a.id_AgendaCliente = ac.id_AgendaCliente
                        JOIN 
                            servico s ON a.id_Servico = s.id_Servico
                        JOIN 
                            profissionais p ON s.id_Profissional = p.id_Profissional
                        WHERE 
                            ac.nome_Cliente LIKE '%$nome_Cliente%'";

                        $resultado = $conexao->query($sql);

                        echo "Foram encontrados $resultado->num_rows clientes agendados <br>";

                        foreach($resultado as $linha){
                            echo "
                                <tr>
                                    <td>" . $linha['id_AgendaCliente'] . "</td>
                                    <td>" . $linha['nome_Cliente'] . "</td>
                                    <td>" . $linha['data_Agenda'] . "</td>
                                    <td>" . $linha['hora'] . "</td>
                                    ...
                                    <td>
                                        <a href='/salao-de-beleza/admin/excluir/admin_excluir_agendamentos.php?id_Agendamento=" . $linha['id_Agendamento'] . "' class='btn btn-danger'>🗑️</a>
                                    </td>
                                </tr>
                            ";
                        }
